...
def listSplit():
    ...
    jumlah_stok=[]
    #harga=[]
    with open("H:\1.Kuliah Informatika UTY\Semester 2\Pemograman Berorientasi Objek Praktik\8\stock.txt","r+") as f:
...
def tambah_buku():
    with open("H:\1.Kuliah Informatika UTY\Semester 2\Pemograman Berorientasi Objek Praktik\8\stock.txt", "a+") as f:
        judul = input("judul = ")
